    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex -flex-col lg:flex-row mt-6 gap-6'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room.images.length > 1 && room.images.map((image, index) => (
                        <img onClick={() => setMainImage(image)} key={index} src={image} alt='Room Image' className={`w-full rounded-xl shadow-md object-cover curosr-pointer ${mainImage === image && 'outline-3 outline-orange-500'}`} />
                    ))}
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                ...
                {/* Room Price */}
                <p className='text-2xl font-medium'><b>₹</b>{room.pricePerNight}/night</p>
            </div>
