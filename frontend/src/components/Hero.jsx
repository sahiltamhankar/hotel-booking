...
const Hero = () => {
    return (
        ...
        <div className='flex flex-col items-start justify-center px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center w-full min-h-screen py-15'>
            ...
            {/* <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-wrap md:flex-row items-start gap-4 w-full max-w-4xl'> */}
            <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8  flex flex-col md:flex-wrap md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
                ...
                <button className='flex items-center justify-center gap-1 rounded-md bg-black py-2 px-4 text-white cursor-pointer md:mt-auto w-full md:w-auto'>
                    <img src={assets.searchIcon} alt='searchIcon' className="h-4" />
                    <span>Search</span>
                </button>
            </form>
